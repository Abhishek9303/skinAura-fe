...
const GoogleRiviewCard = ({ review, reviewer,...props }) => {
  return (
    <div className="relative md:w-[20vmax] md:h-[16vmax] w-[40vmax] h-auto bg-[#d9d9d9cb] rounded-lg shadow-md transition-transform transform hover:scale-105 cursor-pointer">
