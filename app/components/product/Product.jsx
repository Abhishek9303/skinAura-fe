...
const Product = (props) => {
  return (
    <>
      <div className="card relative mx-auto bg-white border-[1px] border-[#0000003b] shadow-md flex flex-col w-[24vmax] h-min-[32vmax] rounded-lg overflow-hidden transition-transform transform hover:scale-105">
