    ...
    <>
      <div className="flex flex-col items-center justify-around py-5">
        <div className="text-center py-5">
          ...
          <p className="w-[80vw]">you are not alone our “ experts “ are here for you</p>
        </div>
        <div className="cards flex flex-col items-center justify-center w-[80vw] lg:flex-row gap-5 lg:gap-20 ">
          {cards.map((card) => (
            <CustomCards
              key={card.title}
              title={card.title}
