      ...
      <SplideTrack>
        <SplideSlide className="w-[100vw] bg-red-300 md:h-[50vh] h-[30vmax] flex items-center justify-end">
          <div className="swiperContent px-8 flex flex-col items-end z-10 mr-12">
            <p>#India's top trusted skin care platform.</p>
            <div className="flex items-center mt-5  justify-center gap-4">
            <h1 className="text-[3vmax] leading-none font-juanaRegular">UNCOVER YOUR</h1>
            <h1 className=" text-[3vmax] leading-none font-juanaSemibold"><i>SKIN’S</i></h1>
            </div>
            <h1 className="text-[3vmax] mb-8 font-juanaRegular">ROOT CAUSE</h1>
